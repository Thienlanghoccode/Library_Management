                                    ...
                                    <div className="tg-footercol">
                                        <strong className="tg-logo">
                                            <a href="javascript:void(0);">
                                                <img
                                                    src="/images/login/haui-logo-rmbg.png"
                                        ...
                                        <ul className="tg-contactinfo">
                                            ...
                                            <li>
                                                ...
                                                <span>Mở Cửa T2 - T7 từ 9h tới 5h</span>
                                            </li>
                                            <li>
                                                <i className="icon-envelope" />
                                                <span>
                                                    <em>
                                                        <a href="mailto:yenthan2004@gmail.com">
                                                            library.haui.com.vn
                                                        </a>
                                                    </em>
                                                </span>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <span className="tg-copyright">2024 All Rights Reserved By © Haui Library</span>
                            </div>
                        </div>
                    </div>
                </div>
